...
const styles = StyleSheet.create({
  ...
  content: {fontSize: 16, color: '#1F1F1F', lineHeight: 23},
  expandBtn: {color: '#5B7EAE', fontSize: 15, marginTop: 3},
  mediaWrapper: {marginBottom: 8},
  location: {fontSize: 12, color: '#7F7F7F', marginBottom: 2},
  footer: {
    flexDirection: 'row',
  ...
  actionBtn: {marginLeft: 14, paddingVertical: 2, paddingHorizontal: 2},
  actionIcon: {fontSize: 17, color: '#979797'},
  socialBlock: {marginBottom: 0},
  commentBorder: {marginTop: 1},
  previewModal: {
    flex: 1,
    backgroundColor: '#000',
