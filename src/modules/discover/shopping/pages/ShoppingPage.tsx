...
const styles = StyleSheet.create({
  ...
  heroHint: {marginTop: 8, fontSize: 13, lineHeight: 19, color: '#FFECEC'},
  heroPromo: {
    marginTop: 14,
    padding: 14,
    borderRadius: 22,
  ...
  heroPromoValue: {marginTop: 5, fontSize: 17, fontWeight: '800', color: '#FFFFFF'},
  heroPromoTime: {fontSize: 12, fontWeight: '700', color: '#FFF3F3'},
  categoryRow: {paddingHorizontal: 16, paddingVertical: 14, gap: 10},
  categoryChip: {
